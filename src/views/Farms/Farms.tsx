  ...
  const farmsList = useCallback(
    (farmsToDisplay: DeserializedFarm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const { poolApr, lpRewardsApr } = isActive
          ? getPoolApr(cakePrice.toNumber(), cakePrice.toNumber(), getBalanceNumber(new BigNumber(farm.totalStakedAmount), 18), CAKE_PER_BLOCK)
          : { poolApr: 0, lpRewardsApr: 0 }
        // const { cakeRewardsApr, lpRewardsApr } = isActive
        //   ? getFarmApr(new BigNumber(farm.poolWeight), cakePrice, totalLiquidity, farm.lpAddresses[ChainId.MAINNET])
        //   : { cakeRewardsApr: 0, lpRewardsApr: 0 }

        return { ...farm, apr: poolApr, lpRewardsApr, liquidity: totalLiquidity }
      })
