  ...
  async ({ account, pids }) => {
    ...
    return userFarmAllowances.map((farmAllowance, index) => {
      return {
        ...
        stakedBalance: userInfos[index].stakedAmount,
        unstakedBalance: userInfos[index].unstakedAmount,
        unstakedRequestTime: userInfos[index].unstakedRequestTimestamp,
